...
v1 scaffold: `preferences` module implemented; `library`, `playback` are placeholders.
...
Auth implementation, library scan, streaming, party WebSocket, sidecars, Lua scripting, native client.
